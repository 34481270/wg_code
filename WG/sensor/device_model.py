...
class DeviceModel:
    ...
    def __init__(self, deviceName, protocolResolver, dataProcessor, dataUpdateListener, portName):
        print("初始化設備")
        self.deviceName = deviceName
        self.protocolResolver = protocolResolver
        self.dataProcessor = dataProcessor
        self.dataUpdateListener = dataUpdateListener
        self.serialConfig = SerialConfig(portName)
